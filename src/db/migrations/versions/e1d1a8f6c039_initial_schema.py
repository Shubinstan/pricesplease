...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'BROKEN', 'PENDING', name='listingstatus'), nullable=False),
    sa.ForeignKeyConstraint(['game_id'], ['games.id'], ),
    sa.ForeignKeyConstraint(['store_id'], ['stores.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_store_remote_id', 'game_listings', ['store_id', 'remote_id'], unique=True)
    ...
    sa.ForeignKeyConstraint(['listing_id'], ['game_listings.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
